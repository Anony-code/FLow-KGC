...
def get_params():
    ...
    args.add_argument("-path", "--data_path", default="../datasets/el", type=str)
    ...
    args.add_argument("-prefix", "--prefix", default="exp-el-1", type=str)
...
data_dir = {
    ...
    'ent2ids': '/ent2ids',
    'relation2ids': '/relation2ids',
    'ent2vec': '/ent2vec.npy',
    'relation2vec': '/relation2vec.npy'
}
