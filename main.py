...
if __name__ == '__main__':
    ...
    dataset['train_tasks_in_train'] = json.load(open(data_dir['train_tasks_in_train']))
    ...
    tmkey = random.sample(dataset['train_tasks'].keys(), 20)
    tmdic = {}
    for key in tmkey:
        tmdic[key] = dataset['train_tasks'][key]

    dataset['train_tasks'] = tmdic
